          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="pu_number" class="form-control pull-right"  >
      ...
      <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="nic" class="form-control pull-right"  >
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="gr1" class="form-control pull-right"  >
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="text" name="gr2" class="form-control pull-right"  >
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>chq no</label>
                <input type="text" name="chq" class="form-control pull-right"  >
