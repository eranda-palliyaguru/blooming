 ...
 date_default_timezone_set("Asia/Colombo");
          ...
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-warning"><?php echo $tre; ?></span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have <?php echo $tre; ?> notifications</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="rip.php"><i class="fa fa-circle-o text-aqua"></i> View customer</a></li>
          </ul>
        </li>
        
        <li>
          <a href="sales.php">
            <i class="fa fa-usd"></i> <span>New Loan</span>
            <span class="pull-right-container">
 ...
 date_default_timezone_set("Asia/Colombo");
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <small class="label pull-right bg-green"><?php echo $rowcount123; ?></small></a></li>
			<li><a href="loan_rp.php?d1=<?php echo $date;?>&d2=<?php echo $date;?>"><i class="fa fa-circle-o text-aqua "></i> Loan Report
            </a></li>
          </ul>
        </li>
        <li class="treeview">
